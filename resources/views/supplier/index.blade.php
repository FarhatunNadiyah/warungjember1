...
<div class="card mt-4 shadow rounded-4">
    <div class="card-header bg-pink text-white rounded-top-4">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="fw-bold mb-0"><i class="fa-solid fa-truck me-2"></i>Data Supplier</h5>
            <a class="btn btn-light text-pink fw-bold rounded-pill px-3" href="{{ url('supplier/create') }}">
    ...
    <input type="text" name="search" class="form-control me-2" placeholder="Cari nama supplier..." value="{{ request('search') }}">
    <div class="col-md-2">
            ...
            <div class="table-responsive">
                <table class="table align-middle text-center table-hover rounded overflow-hidden">
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #fef3f7;">
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('supplier.edit', $supplier->id) }}" class="btn btn-warning btn-sm fw-bold rounded-pill px-3">Edit</a>
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="text-muted text-center">Belum ada supplier.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
...
<div class="d-flex justify-content-center mt-4">
    <ul class="pagination pagination-custom">
        ...
        <li class="page-item active"><a class="page-link" href="{{ url('/supplier') }}">4</a></li>
